...
function combattre(){ if(enZoneFaction()){ journal("La chasse se fait en zone sauvage.","alerte"); return; } if(!depenserEnergie(aptEnergieAction(ACTION_COUT.combattre)))return; const l=lieuActuel(); resoudreCombat(!!(l && l.type==="chasse")); }

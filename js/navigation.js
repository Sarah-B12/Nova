...
function changerHub(h){ montrerHub(h); if(h==="terrain") majTerrain(); if(h==="centre") majCentre(); }
...
function majHub(){
  ...
  const dispo={ terrain: ville===etat.faction, centre: !!ville, poste: !!ville, marche: !!ville, voler: !!ville };
